<?php 
    ...
    // Titres dynamiques (On garde ta logique Alpha)
    $titreHero = "Bienvenue dans le Lab V2";
    $sousTitreHero = "Architecture robuste & Design System sous surveillance Sonar.";
...
<head>
    ...
    <title>LAB-CREA-CODE | V2 Architecture</title>
...
<?php 
    // Inclusion du header (qui doit contenir le bouton #theme-switch)
    ...
    <div id="projets" class="container">
        <?php 
            if (file_exists($file)) {
                ...
                echo "<section class='section-projects'><h1>Page Vierge</h1><p>Prêt pour le nouveau contenu de la page : <strong>$page</strong>.</p></section>";
            }
        ?>
    </div>
</main>
...
<script src="src/js/theme.js?v=<?php echo time(); ?>"></script>
